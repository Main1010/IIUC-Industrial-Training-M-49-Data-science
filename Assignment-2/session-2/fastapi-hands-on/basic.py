...
news = {
    1:
    {
        ...
        "content": "If are learning python then article is for you",
        "author": "Main"
    },
    2:
    {
        ...
        "content": "If are starting to do Research Paper then article is for you",
        "author": "Taivan"
    },
    3:
    {
        "id": 3,
        "title": "Competative Programming is an art",
        "content": "If want to be competative programmer then article is for you",
        "author": "Tuhin"
    },
}
...
def news_by_title(title_contains: str):
    ...
    return {"data": "No news found with title "+title_contains}
