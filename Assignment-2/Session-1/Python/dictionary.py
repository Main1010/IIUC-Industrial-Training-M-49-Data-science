...
print("Student after adding a subject:", student)

# Removing a subject and grade
removed_grade = student['grades'].pop('science')
print("Removed grade:", removed_grade)
print("Student after removing a subject:", student)

# Modifying a grade
student['grades']['math'] = 80
print("Student after modifying a grade:", student)
