...
# Accessing elements
print("Element in the second row and third column:", matrix_2d[1][2])

# Modifying elements
matrix_2d[0][0] = 0
print("Modified matrix after changing first element:", matrix_2d)
...
# Write your code below:
mixed_tuple = ("John", 25, "john@example.com", True)

# Using the tuple as keys in a dictionary
user_info = {
    mixed_tuple: {
        "name": mixed_tuple[0],
        "age": mixed_tuple[1],
        "email": mixed_tuple[2],
        "verified": mixed_tuple[3]
    }
}
...
print("Sorted students by grades:", sorted_students)
